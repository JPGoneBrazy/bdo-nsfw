...
This mod hides all armors for all classes (except Shai), up to Seraph. It has 2 options to allow you to customize which subset of outfits/armors to remove/hide from the game:
